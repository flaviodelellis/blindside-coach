...
const it: Dict = {
  ...
  "vd.field.random_seed": "Random seed (opzionale)",
  "vd.placeholder.random_seed": "vuoto = casuale",
...
const en: Dict = {
  ...
  "vd.field.random_seed": "Random seed (optional)",
  "vd.placeholder.random_seed": "blank = random",
